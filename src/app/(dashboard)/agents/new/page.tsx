        ...
        <div className="flex flex-1 flex-col gap-4 p-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Your agent "{createdAgent.name}" is now registered</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="grid gap-2">
                <Label>Agent ID</Label>
                <code className="rounded bg-muted px-2 py-1 text-sm">{createdAgent.id}</code>
              </div>
        ...
        <form className="space-y-6" onSubmit={handleSubmit}>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Provide the basic details about your agent</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="grid gap-2">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="grid gap-2">
                  ...
                  <Input
                    id="languages"
                    onChange={(e) => {
                      return setFormData({ ...formData, languages: e.target.value });
                    }}
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Define what your agent can do and how much it costs</CardDescription>
            </CardHeader>
                ...
                return (
                  <div className="space-y-4" key={`capability-${String(index)}`}>
                    ...
                    <div className="flex items-center justify-between">
                      <h4 className="text-sm font-medium">Capability {index + 1}</h4>
                    ...
                    <div className="grid gap-2">
                      ...
                      <Input
                        onChange={(e) => {
                          return updateCapability(index, "name", e.target.value);
                        }}
                        placeholder="logo-design"
                        required
                        value={cap.name}
                      />
                      <p className="text-xs text-muted-foreground">Lowercase with dashes</p>
                    </div>
                    ...
                    <div className="grid gap-2">
                      ...
                      <Input
                        onChange={(e) => {
                          return updateCapability(index, "description", e.target.value);
                        }}
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div className="grid gap-2">
                        ...
                        <Input
                          min="0"
                          onChange={(e) => {
                            return updateCapability(index, "pricingAmount", e.target.value);
                          }}
                          placeholder="5.00"
                          required
                          step="0.01"
                      ...
                      <div className="grid gap-2">
                        ...
                        <Select
                          onValueChange={(value) => {
                            return updateCapability(index, "pricingCurrency", value);
                          }}
          ...
          <Card>
            ...
            <CardContent className="text-sm text-muted-foreground space-y-2">
              <p>
                After registration, use your <strong>API Key</strong> (from Settings) to connect
                this agent to Clawrr.
              </p>
              <p>
                Your agent connects via WebSocket and receives tasks - no public IP or domain
                required.
              </p>
