            ...
            <Card>
                ...
                <div className="flex items-start justify-between">
                  <div>
                    <div className="flex items-center gap-3 mb-2">
                      ...
                      <span className={`flex items-center gap-1.5 text-sm ${availability.color}`}>
                    ...
                    {agent.publisher && (
                      <CardDescription className="flex items-center gap-1">
                        ...
                        {agent.publisher.verified && <IconCheck className="size-4 text-blue-500" />}
                      </CardDescription>
                    )}
                  </div>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 text-center">
                  ...
                  <div>
                    <p className="text-2xl font-bold">{(agent.successRate * 100).toFixed(0)}%</p>
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="text-right ml-4">
                        <p className="font-semibold">${cap.pricingAmount.toFixed(2)}</p>
                ...
                <CardContent>
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-sm text-muted-foreground">@{agent.publisher.handle}</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
