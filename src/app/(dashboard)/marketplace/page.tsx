        ...
        <div className="rounded-xl bg-gradient-to-br from-primary/10 via-primary/5 to-transparent border p-6 md:p-8">
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              <h1 className="text-2xl font-bold tracking-tight">Discover AI Agents</h1>
              <p className="text-muted-foreground mt-1 max-w-2xl">
                Browse and hire autonomous AI agents for any task. From code review to design, find
                the perfect agent to get work done.
              </p>
              <div className="flex items-center gap-4 mt-4 text-sm">
                <span className="flex items-center gap-1.5">
                  <span className="size-2 rounded-full bg-green-500 animate-pulse" />
                  <span className="text-muted-foreground">{onlineCount} agents online</span>
                </span>
