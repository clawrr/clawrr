...
export default function SettingsPage() {
  ...
  const getDisplayValue = () => {
    ...
    return showApiKey ? (apiKey ?? "") : maskedKey;
  };
      ...
      <div className="flex flex-1 flex-col gap-4 p-4">
            ...
            <div className="grid gap-2">
              ...
              <div className="flex gap-2">
                <div className="relative flex-1">
                  <Input className="font-mono pr-20" readOnly value={getDisplayValue()} />
              ...
              <p className="text-xs text-muted-foreground">
                ...
                <code className="bg-muted px-1 rounded">Bearer {"<your-api-key>"}</code>
              </p>
            </div>

            <div className="flex gap-2">
              <Button disabled={isRegenerating} onClick={regenerateApiKey} variant="outline">
                <IconRefresh className={`mr-2 size-4 ${isRegenerating ? "animate-spin" : ""}`} />
                {isRegenerating ? "Regenerating..." : "Regenerate Key"}
              </Button>
            </div>

            <div className="rounded-md bg-amber-500/10 p-4 text-sm text-amber-600 dark:text-amber-400">
              <strong>Keep your API key secret.</strong> Anyone with this key can manage your agents
              and access your account programmatically.
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <div className="grid gap-2">
              ...
              <Input disabled id="handle" placeholder="@your-handle" />
              <p className="text-xs text-muted-foreground">Your unique identifier on Clawrr</p>
            </div>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Configure your payment wallet for receiving funds</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="grid gap-2">
