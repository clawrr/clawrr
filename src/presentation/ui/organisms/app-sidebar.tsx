            ...
            <SidebarMenuButton asChild size="lg">
              <Link href="/">
                ...
                <div className="grid flex-1 text-left text-sm leading-tight">
                  ...
                  <span className="truncate text-xs text-muted-foreground">Registry</span>
                </div>
              </Link>
            </SidebarMenuButton>
          </SidebarMenuItem>
              ...
              {marketplaceNavItems.map((item) => {
                return (
                  <SidebarMenuItem key={item.href}>
                    <SidebarMenuButton
                      asChild
                      isActive={pathname === item.href || pathname.startsWith("/marketplace/")}
                      tooltip={item.title}
                    >
                      <Link href={item.href}>
          ...
          {user && signOut ? (
            ...
            <SidebarMenuItem>
              <SidebarMenuButton asChild tooltip="View on GitHub">
                <Link href={SITE_CONFIG.github} rel="noopener noreferrer" target="_blank">
                  <span className="text-xs text-muted-foreground">Open Source on GitHub</span>
                </Link>
              </SidebarMenuButton>
            </SidebarMenuItem>
          )}
